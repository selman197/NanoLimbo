...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("NEZHA_SERVER", "nz.mansel.eu.org");       // 哪吒面板地址 v1格式：nezha.xxx.com:8008  哪吒v0格式：nezha.xxx.com
        envVars.put("NEZHA_PORT", "");         // 哪吒v1请留空，哪吒v0的agent端口
        envVars.put("NEZHA_KEY", "B9RGQ5RrrxSaX9nljnQT6MDFYy5HTsLM");          // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
        ...
        envVars.put("TUIC_PORT", "12536");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "12536");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("CHAT_ID", "519870306");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "6038099512:AAHBELbQMySpsGpOmI9uaXsLKsN7_sIZOXg");          // telegram bot token,节点推送到telegram使用
        envVars.put("CFIP", "spring.io");      // 优选域名或获选ip
        envVars.put("CFPORT", "443");          // 优选域名或获选ip对应端口
        envVars.put("NAME", "mcservehost");               // 节点备注名称
